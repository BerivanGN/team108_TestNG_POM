...
public class C06_Softassert {
    ...
    public void webappTesti(){
        ...
        softAssert.assertEquals(actualsecim,expectedSecim,"dropDown'da eurosone seçili değil");
        ...
        List<String> actualoptionStringList = ReusableMethods.stringListeCevir(optionElementListesi);
